                ...
                {toasts.map(toast => (
                    <div
                        ...
                        className={`
                            ...
                            ${toast.type === 'success' ? 'bg-black border-green-500 text-white' : ''}
                            ${toast.type === 'sell' || toast.type === 'error' ? 'bg-black border-red-500 text-white' : ''}
                            ${toast.type === 'info' ? 'bg-black border-white text-white' : ''}
                        `}
                    >
                        {toast.message}
                    </div>
