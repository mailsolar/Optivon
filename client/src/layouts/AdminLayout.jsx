...
export default function AdminLayout() {
    ...
    return (
        <div className="flex h-screen bg-background text-primary font-sans overflow-hidden selection:bg-accent selection:text-background">
            {/* Admin Sidebar */}
            <aside className="w-64 bg-surface border-r border-black/15 flex flex-col">
                ...
                <div className="p-4 border-t border-black/15">
                    <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 text-gray-400 hover:text-primary hover:bg-white/5 rounded-xl transition-colors"
                    >
                        <LogOut size={18} />
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                <header className="h-16 border-b border-black/15 flex items-center px-8 justify-between bg-surface">
                    <button 
