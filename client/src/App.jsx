    ...
    return (
        <>
            <Routes>
                ...
                <Route path="/capital-tiers" element={<DummyInfo title="Capital Tiers" subtitle="Scaled allocation nodes designed for evolving institutional requirements." content={[{header: "Tier Allocation", text: "From ₹50,000 to ₹50L+, our tiers are calibrated to match trader performance with systemic risk parameters."}, {header: "Scaling Protocol", text: "Traders demonstrating consistent alpha generation are eligible for node expansion and increased liquidity access."}]} />} />
