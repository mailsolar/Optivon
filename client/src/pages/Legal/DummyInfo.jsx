    ...
    return (
        <div className="min-h-screen bg-background text-primary font-sans p-6 md:p-12 selection:bg-accent/30">
            <div className="max-w-[1200px] mx-auto">
                ...
                {/* Header / Navigation */}
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-20 border-b border-black/15 pb-8 gap-8">
                    <button 
                        onClick={() => navigate(-1)}
                        className="flex items-center gap-4 text-[12px] font-bold text-secondary hover:text-primary uppercase tracking-[0.3em] transition-all group"
                    >
                    ...
                    <div className="text-right">
                        ...
                        <div className="text-[10px] font-bold text-secondary uppercase tracking-widest">{new Date().toLocaleDateString()} SYNC</div>
                    </div>
                </div>
                ...
                >
                    <h1 className="text-7xl md:text-[8vw] font-display font-black tracking-tighter mb-8 leading-[0.85] uppercase text-primary">
                        {title}
                    </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-40">
                    ...
                    <div className="lg:col-span-8 space-y-12">
                        {content.map((block, i) => (
                            <motion.div 
                                ...
                                className="p-12 bg-surface border border-black/15"
                            >
                                <div className="text-[12px] font-display font-black text-accent uppercase tracking-[0.3em] mb-4">APPENDIX 0{i+1}</div>
                                <h2 className="text-3xl font-display font-black text-primary mb-6 uppercase tracking-tighter">{block.header}</h2>
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-8">
                        ...
                        <div className="p-10 bg-surface border border-black/15">
                            ...
                            <div className="space-y-4">
                                {['Strategic Mandate', 'Capital Allocations', 'Security Tier 01'].map(ref => (
                                    <div key={ref} className="group flex items-center justify-between py-4 border-b border-black/15 cursor-pointer">
                                        <span className="text-sm font-bold text-primary group-hover:text-accent transition-colors uppercase tracking-widest">{ref}</span>
                ...
                {/* Footer Insight */}
                <div className="pt-12 border-t border-black/15/[0.05] flex flex-col md:flex-row justify-between items-center gap-8 opacity-40">
